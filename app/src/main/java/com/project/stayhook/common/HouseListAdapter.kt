...
class HouseListAdapter(val list:ArrayList<String>, val context: Context): RecyclerView.Adapter<HouseListAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view= LayoutInflater.from(context).inflate(R.layout.house_preview_layout,parent,false)
